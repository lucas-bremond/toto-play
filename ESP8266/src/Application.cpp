...
#include <TotoPlay/Application.hpp>
...
{
	return wifiManager_.isActive() || timeManager_.isActive() || serverManager_.isActive() || actionManager_.isActive() ;
}
...
void							Application::onClockSet						( )
{
	...
	if (!actionManager_.isActive())
	{
		...
		serverManager_.associateActionManager(actionManager_) ;
...
TotoPlay::Application			application ;
